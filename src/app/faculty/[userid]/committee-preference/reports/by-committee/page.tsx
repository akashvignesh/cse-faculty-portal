...
import CommitteeReportByCommitteeTable from "@/components/committee-preference/CommitteeReportByCommitteeTable";
...
import { buildByCommitteeReport } from "@/services/committee/committeeReportService";
import { findFacultyByUserid, loadFacultyRecords } from "@/services/faculty/facultyService";
import type { Faculty } from "@/types/faculty";

export default function CommitteeReportByCommitteePage() {
  ...
  useEffect(() => {
    document.title = `Committee Report — By Committee | ${APP_TITLE}`;
  }, []);

  const rows = useMemo(
    () => buildByCommitteeReport(records, columns, memberships),
              ...
              <div className="faculty-profile-layout">
                ...
                <section className="faculty-secondary-card">
                  <div className="faculty-committee-heading">
                    <h2>Committee Report — By Committee</h2>
                    <p>Committee assignments grouped by committee for {academicYear}.</p>
                  </div>
                  ...
                  <div className="faculty-secondary-body">
                    <div className="faculty-secondary-section faculty-preference-section-inline">
                      ...
                      <CommitteeReportByCommitteeTable rows={rows} />
                    </div>
                  </div>
                </section>
              </div>
