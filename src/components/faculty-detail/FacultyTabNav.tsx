...
const TAB_LABELS: { tab: DetailTab; label: string }[] = [
  { tab: DETAIL_TABS.RESEARCH_AREA, label: "Research Areas" },
  { tab: DETAIL_TABS.TEACHING_HISTORY, label: "Teaching History" },
  { tab: DETAIL_TABS.COURSE_PREFERENCE, label: "Course Preferences" },
  { tab: DETAIL_TABS.LEAVE, label: "Leave" },
  { tab: DETAIL_TABS.COMMITTEE, label: "Committees" },
  { tab: DETAIL_TABS.AWARDS, label: "Awards" },
  { tab: DETAIL_TABS.STUDENT, label: "Students" },
];
